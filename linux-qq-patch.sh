...
echo -e "\e[32mExtracting deb...\e[0m"
...
echo -e "NapCat installation complete. Run \e[32mnapcat -q <QQ number> \e[0m to start NapCat"
EOF
...
echo -e "\e[32mStarting Xvfb...\e[0m"
sleep 2
export DISPLAY=:1
cd \$HOME/napcat
echo -e "\e[32mStarting NapCat...\e[0m"
...
cd $qq_path
echo -e "\e[32mUpdating md5sum...\e[0m"
find . -type f -exec md5sum {} \; | sed 's| ./| |' > $qq_path/DEBIAN/md5sums

cd $cwd
echo -e "\e[32mPackaging deb...\e[0m"
